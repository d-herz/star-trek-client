...
async function apiRequest(){
  const alienName = document.querySelector('input').value.toLowerCase() //tolowercase?
  try{
    const response = await fetch(`https://star-trek-api-dh.herokuapp.com/api/${alienName}`)
